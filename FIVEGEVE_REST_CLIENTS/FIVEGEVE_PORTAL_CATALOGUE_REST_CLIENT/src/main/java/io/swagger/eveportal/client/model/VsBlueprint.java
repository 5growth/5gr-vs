...
public class VsBlueprint {
  ...
  public enum CompatibleSitesEnum {
    ...
    SPAIN_5GROWTH_INNOVALIA_BILBAO("SPAIN_5GROWTH_INNOVALIA_BILBAO");
  ...
  public VsBlueprint applicationMetrics(List<ApplicationMetric> applicationMetrics) {
    this.applicationMetrics = applicationMetrics;
    return this;
  }

  public VsBlueprint addApplicationMetricsItem(ApplicationMetric applicationMetricsItem) {
  ...
  **/
  ...
  public VsBlueprint atomicComponents(List<VsComponent> atomicComponents) {
    this.atomicComponents = atomicComponents;
    return this;
  }

  public VsBlueprint addAtomicComponentsItem(VsComponent atomicComponentsItem) {
  ...
  **/
  ...
  public VsBlueprint blueprintId(String blueprintId) {
  ...
  **/
  ...
  public VsBlueprint compatibleContextBlueprint(List<String> compatibleContextBlueprint) {
    this.compatibleContextBlueprint = compatibleContextBlueprint;
    return this;
  }

  public VsBlueprint addCompatibleContextBlueprintItem(String compatibleContextBlueprintItem) {
    if (this.compatibleContextBlueprint == null) {
      this.compatibleContextBlueprint = new ArrayList<String>();
    }
    this.compatibleContextBlueprint.add(compatibleContextBlueprintItem);
    return this;
  }

   /**
   * Get compatibleContextBlueprint
  ...
  **/
  ...
  public void setCompatibleContextBlueprint(List<String> compatibleContextBlueprint) {
    this.compatibleContextBlueprint = compatibleContextBlueprint;
  }

  public VsBlueprint compatibleSites(List<CompatibleSitesEnum> compatibleSites) {
    this.compatibleSites = compatibleSites;
    return this;
  }

  public VsBlueprint addCompatibleSitesItem(CompatibleSitesEnum compatibleSitesItem) {
  ...
  **/
  ...
  public VsBlueprint configurableParameters(List<String> configurableParameters) {
    this.configurableParameters = configurableParameters;
    return this;
  }

  public VsBlueprint addConfigurableParametersItem(String configurableParametersItem) {
  ...
  **/
  ...
  public VsBlueprint connectivityServices(List<VsbLink> connectivityServices) {
    this.connectivityServices = connectivityServices;
    return this;
  }

  public VsBlueprint addConnectivityServicesItem(VsbLink connectivityServicesItem) {
  ...
  **/
  ...
  public VsBlueprint description(String description) {
  ...
  **/
  ...
  public VsBlueprint endPoints(List<VsbEndpoint> endPoints) {
    this.endPoints = endPoints;
    return this;
  }

  public VsBlueprint addEndPointsItem(VsbEndpoint endPointsItem) {
  ...
  **/
  ...
  public VsBlueprint name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public VsBlueprint parameters(List<VsBlueprintParameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public VsBlueprint addParametersItem(VsBlueprintParameter parametersItem) {
  ...
  **/
  ...
  public VsBlueprint serviceSequence(List<VsbForwardingPathHop> serviceSequence) {
    this.serviceSequence = serviceSequence;
    return this;
  }

  public VsBlueprint addServiceSequenceItem(VsbForwardingPathHop serviceSequenceItem) {
  ...
  **/
  ...
  public VsBlueprint version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VsBlueprint vsBlueprint = (VsBlueprint) o;
    return Objects.equals(this.applicationMetrics, vsBlueprint.applicationMetrics) &&
        Objects.equals(this.atomicComponents, vsBlueprint.atomicComponents) &&
        Objects.equals(this.blueprintId, vsBlueprint.blueprintId) &&
        Objects.equals(this.compatibleContextBlueprint, vsBlueprint.compatibleContextBlueprint) &&
        Objects.equals(this.compatibleSites, vsBlueprint.compatibleSites) &&
        Objects.equals(this.configurableParameters, vsBlueprint.configurableParameters) &&
        Objects.equals(this.connectivityServices, vsBlueprint.connectivityServices) &&
        Objects.equals(this.description, vsBlueprint.description) &&
        Objects.equals(this.endPoints, vsBlueprint.endPoints) &&
        Objects.equals(this.name, vsBlueprint.name) &&
        Objects.equals(this.parameters, vsBlueprint.parameters) &&
        Objects.equals(this.serviceSequence, vsBlueprint.serviceSequence) &&
        Objects.equals(this.version, vsBlueprint.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationMetrics, atomicComponents, blueprintId, compatibleContextBlueprint, compatibleSites, configurableParameters, connectivityServices, description, endPoints, name, parameters, serviceSequence, version);
  }
  ...
  public String toString() {
    ...
    sb.append("    compatibleContextBlueprint: ").append(toIndentedString(compatibleContextBlueprint)).append("\n");
