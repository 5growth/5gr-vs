...
public class EvsTestNfvoLcmDriver extends NfvoLcmAbstractDriver {
	...
	private static final Logger log = LoggerFactory.getLogger(EvsTestNfvoLcmDriver.class);

	public EvsTestNfvoLcmDriver(String nfvoAddress,
                                NfvoLcmNotificationInterface nfvoNotificationManager,
                                NfvoLcmOperationPollingManager nfvoOperationPollingManager) {
		super(NfvoLcmDriverType.EVS_TEST, nfvoAddress, nfvoNotificationManager);
